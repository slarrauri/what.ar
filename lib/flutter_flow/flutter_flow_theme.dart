...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFED5324);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFFB1B1B1);
  late Color alternate = const Color(0xFF636363);
  late Color primaryText = const Color(0xFF151515);
  late Color secondaryText = const Color(0xFF151515);
  late Color primaryBackground = const Color(0xFFED5324);
  late Color secondaryBackground = const Color(0xFFED5324);
